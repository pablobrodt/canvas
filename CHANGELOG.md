...
## [0.0.2] - 2026-05-01
### Added
- **Transparent PNG Export**: PNG exports now feature a 100% transparent background, automatically excluding utility elements like the grid and selection transformer for clean, professional assets.
